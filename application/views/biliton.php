    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Overview Test Covid Point Of Care Honda Biliton</h4>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-round">
                        <div class="card-body">
                            <form method="post" action="<?php echo base_url(); ?>Biliton/laporan">
                                <div class="row">
                                    <div class="col-sm-3">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-head-row">
                                <h4 class="card-title">Laporan Pasien Test Covid 19 Point Of Care Honda Biliton</h4>
                            </div>
